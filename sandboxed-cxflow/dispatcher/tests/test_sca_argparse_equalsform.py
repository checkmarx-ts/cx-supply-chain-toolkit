...
class sca_argparse_equals_tests(unittest.TestCase):
    ...
    def test_offline_input_param_modified_short(self):
        o = sca_argparse.ScaArgsHandler(["", "offline", f"-s={sca_argparse_equals_tests.__inpath}", f"-r={sca_argparse_equals_tests.__outpath}"])
        mod = o.get_modified_params(sca_argparse_equals_tests.__mod_inpath, sca_argparse_equals_tests.__mod_outpath)
        self.assertEqual(o.input_path_index, mod.index(sca_argparse_equals_tests.__mod_inpath))
    ...
    def test_offline_output_param_modified_short(self):
        o = sca_argparse.ScaArgsHandler(["", "offline", f"-s={sca_argparse_equals_tests.__inpath}", f"-r={sca_argparse_equals_tests.__outpath}"])
        mod = o.get_modified_params(sca_argparse_equals_tests.__mod_inpath, sca_argparse_equals_tests.__mod_outpath)
        self.assertEqual(o.output_path_index, mod.index(sca_argparse_equals_tests.__mod_outpath))

    def test_offline_output_param_modified_long(self):
        o = sca_argparse.ScaArgsHandler(["", "offline", f"--scan-path={sca_argparse_equals_tests.__inpath}", f"--resolver-result-path={sca_argparse_equals_tests.__outpath}"])
        mod = o.get_modified_params(sca_argparse_equals_tests.__mod_inpath, sca_argparse_equals_tests.__mod_outpath)
        self.assertEqual(o.output_path_index, mod.index(sca_argparse_equals_tests.__mod_outpath))
    ...
    def test_online_output_param_modified_long(self):
        o = sca_argparse.ScaArgsHandler(["", "online", f"--scan-path={sca_argparse_equals_tests.__inpath}", f"--resolver-result-path={sca_argparse_equals_tests.__outpath}"])
        mod = o.get_modified_params(sca_argparse_equals_tests.__mod_inpath, sca_argparse_equals_tests.__mod_outpath)
        self.assertEqual(o.output_path_index, mod.index(sca_argparse_equals_tests.__mod_outpath))
